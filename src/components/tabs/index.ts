...
export const tabsTriggerVariants = cva(
  'inline-flex items-center justify-center text-sm font-semibold ring-offset-background transition-all focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-foreground',
  {
    variants: {
      variant: {
        default:
          'h-10 px-5 py-2.5 whitespace-nowrap rounded-sm text-foreground opacity-[0.56] hover:opacity-100 data-[state=active]:opacity-100 data-[state=active]:bg-background data-[state=active]:shadow-tab data-[state=active]:border data-[state=active]:border-primary/16 dark:data-[state=active]:border-white/16 border border-transparent',
        ghost:
