...
import { BuiSeparator as Separator } from '@/components/separator'
import { BuiFormItem as FormItem, BuiFormMessage as FormMessage } from '@/components/form'
import { BuiCard, BuiCardContent, BuiCardHeader, BuiCardTitle } from '@/components/card'
  ...
  <FieldArray v-slot="{ fields, remove, push }" as="section" :name="fieldName">
    <slot v-bind="props">
      <BuiCard as-child class="w-full border-0 shadow-none">
        <FormItem>
          <BuiCardHeader class="border-b-border/16 border-b py-1">
          ...
          <BuiCardContent class="flex flex-col gap-5 pr-0 pb-0">
