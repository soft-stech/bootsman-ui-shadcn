  ...
  <SwitchRoot
    ...
    :class="
      cn(
        ...
        focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed
        data-[state=checked]:border-border data-[state=unchecked]:border-gray-300 data-[state=checked]:bg-primary data-[state=unchecked]:bg-background
